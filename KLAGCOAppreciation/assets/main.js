...
(function() {
	...
	// Initialize "On Visible" animations.
		onvisible.add('#text02', { style: 'fade-up', speed: 1000, intensity: 5, threshold: 3, delay: 0, replay: false });
		onvisible.add('#text05', { style: 'fade-up', speed: 1000, intensity: 5, threshold: 3, delay: 0, replay: false });
		onvisible.add('#image02', { style: 'fade-up', speed: 1000, intensity: 5, threshold: 3, delay: 0, replay: false });
