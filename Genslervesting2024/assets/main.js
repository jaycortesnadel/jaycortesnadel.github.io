					...
					'southcentral': {
						events: {
							onopen: [
								function() { 
									gtag('event', 'page_view', {
										'page_title': 'Southcentral',
										'page_location': '/#southcentral',
									});
								},
							],
						},
					...
					'southwest': {
						events: {
							onopen: [
								function() { 
									gtag('event', 'page_view', {
										'page_title': 'Southwest',
										'page_location': '/#southwest',
									});
								},
							],
						},
					...
					'cutterandbuck': {
						events: {
							onopen: [
								function() { 
									gtag('event', 'page_view', {
										'page_title': 'Cutterandbuck',
										'page_location': '/#cutterandbuck',
									});
								},
							],
						},
					...
					'northface': {
						events: {
							onopen: [
								function() { 
									gtag('event', 'page_view', {
										'page_title': 'Northface',
										'page_location': '/#northface',
									});
								},
							],
						},
					...
					'portauthority': {
						events: {
							onopen: [
								function() { 
									gtag('event', 'page_view', {
										'page_title': 'Portauthority',
										'page_location': '/#portauthority',
									});
								},
							],
						},
