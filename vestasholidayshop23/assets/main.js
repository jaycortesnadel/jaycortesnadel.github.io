				...
				sections = {
					'orderform': {
						events: {
							onopen: [
								function() { 
									gtag('config', 'G-LNKNNHT1TS', { 'page_path': '/#orderform' });
								},
							],
						},
					},
					'thankyou': {
						events: {
							onopen: [
								function() { 
									gtag('config', 'G-LNKNNHT1TS', { 'page_path': '/#thankyou' });
								},
							],
						},
					},
					'home': {
						events: {
							onopen: [
								function() { 
									gtag('config', 'G-LNKNNHT1TS', { 'page_path': '/' });
								},
							],
						},
					},
	...
	// Initialize background.
		(function() {
			...
			new slideshowBackground('bg', {
				...
				images: [
					{
						src: 'assets/images/bg-d62d4643.jpg',
						position: 'center',
						motion: 'none',
						speed: 2,
						caption: 'Untitled',
					...
					{
						src: 'assets/images/bg-a6861374.jpg',
						position: 'center',
						motion: 'none',
						speed: 2,
						caption: 'Untitled',
					...
					{
						src: 'assets/images/bg-6cb5c480.jpg',
						position: 'center',
						motion: 'none',
						speed: 2,
						caption: 'Untitled',
					...
					{
						src: 'assets/images/bg-682da3ce.jpg',
						position: 'center',
						motion: 'none',
						speed: 2,
						caption: 'Untitled',
